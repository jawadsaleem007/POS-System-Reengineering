...
public class POSSystem{
  // Refactored: Removed public access modifier for encapsulation
  private boolean unixOS = true; 
  
  // Refactored: Made constants final
  ...
  public static final String itemDatabaseFile = "Database/itemDatabase.txt"; 
